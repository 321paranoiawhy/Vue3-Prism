(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["Vue3Prism"] = factory(require("vue"));
	else
		root["Vue3Prism"] = factory(root["Vue"]);
...
;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-82.use[1]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/plugin/Vue3Prism.vue?vue&type=template&id=17d09320&scoped=true


const _withScopeId = n => (_pushScopeId("data-v-17d09320"), n = n(), _popScopeId(), n);

const _hoisted_1 = ["innerHTML"];
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)("pre", {
    ref: "preNode",
    class: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.normalizeClass)('language-' + $props.language)
  }, [(0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("code", {
    class: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.normalizeClass)('language-' + $props.language),
    innerHTML: $setup.prismHTML
  }, null, 10, _hoisted_1)], 2);
}
;// CONCATENATED MODULE: ./src/plugin/Vue3Prism.vue?vue&type=template&id=17d09320&scoped=true

// EXTERNAL MODULE: ./node_modules/prismjs/prism.js
var prism = __webpack_require__(5939);
...
function createSetter(shallow = false) {
  return function set(target, key, value, receiver) {
    ...
    if (target === reactivity_esm_bundler_toRaw(receiver)) {
      if (!hadKey) {
        reactivity_esm_bundler_trigger(target, "add"
        /* ADD */
        , key, value);
      } else if (shared_esm_bundler_hasChanged(value, oldValue)) {
        reactivity_esm_bundler_trigger(target, "set"
        /* SET */
        , key, value, oldValue);
      }
    }
...
function deleteProperty(target, key) {
  ...
  if (result && hadKey) {
    reactivity_esm_bundler_trigger(target, "delete"
    /* DELETE */
...
function clear() {
  ...
  if (hadItems) {
    reactivity_esm_bundler_trigger(target, "clear"
    /* CLEAR */
...
function emit$1(instance, event, ...rawArgs) {
  ...
  props[handlerName = shared_esm_bundler_toHandlerKey(shared_esm_bundler_camelize(event))]; // for v-model update:xxx events, also trigger kebab-case equivalent
...
function injectHook(type, hook, target = currentInstance, prepend = false) {
  if (target) {
    ...
    const wrappedHook = hook.__weh || (hook.__weh = (...args) => {
      ...
      reactivity_esm_bundler_pauseTracking(); // Set currentInstance during hook invocation.
...
;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-82.use[1]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/plugin/Vue3Prism.vue?vue&type=script&lang=js
...
/* harmony default export */ var Vue3Prismvue_type_script_lang_js = ({
  name: "Vue3Prism",
  // use like this
  ...
  setup(props) {
    const preNode = reactivity_esm_bundler_ref(null);
    onMounted(() => {
      // 1. line-numbers
      ...
      copySpan.onclick = () => {
        ...
        copySpan.innerHTML = props.copiedTip; // https://www.zhangxinxu.com/wordpress/2021/10/js-copy-paste-clipboard/
        ...
        if (navigator.clipboard) {
          ...
          document.body.appendChild(textarea); // hide textarea

          textarea.style.position = "fixed"; // This property is deprecated. Use clip-path instead: https://developer.mozilla.org/en-US/docs/Web/CSS/clip
          // textarea.style.clip = "rect(0 0 0 0)";
          // css-tricks clip-path: https://css-tricks.com/almanac/properties/c/clip-path/

          textarea.style.clipPath = "circle(0)";
          textarea.style.top = "10px"; // assign value

          textarea.value = props.source;
          textarea.select();
          document.execCommand("copy", true); // remove
      ...
      languageSpan.style.color = "#00e0e0"; // 4. show Prism
    ...
    const prismHTML = prism_default().highlight(`${props.source}`, (prism_default()).languages[props.language], "javascript");
    return {
      preNode,
      prismHTML
    };
...
;// CONCATENATED MODULE: ./src/plugin/Vue3Prism.vue?vue&type=script&lang=js
 
;// CONCATENATED MODULE: ./node_modules/mini-css-extract-plugin/dist/loader.js??clonedRuleSet-64.use[0]!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-64.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-64.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-64.use[3]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/plugin/Vue3Prism.vue?vue&type=style&index=0&id=17d09320&lang=scss&scoped=true
// extracted by mini-css-extract-plugin

;// CONCATENATED MODULE: ./src/plugin/Vue3Prism.vue?vue&type=style&index=0&id=17d09320&lang=scss&scoped=true

// EXTERNAL MODULE: ./node_modules/vue-loader/dist/exportHelper.js
var exportHelper = __webpack_require__(1620);
;// CONCATENATED MODULE: ./src/plugin/Vue3Prism.vue
...
const __exports__ = /*#__PURE__*/(0,exportHelper/* default */.Z)(Vue3Prismvue_type_script_lang_js, [['render',render],['__scopeId',"data-v-17d09320"]])

/* harmony default export */ var Vue3Prism = (__exports__);
...
/* harmony default export */ var src_plugin = (Vue3Prism);
;// CONCATENATED MODULE: ./src/index.js
// import index.js

 // store all components in an array

const components = [src_plugin]; // define install function

const install = App => {
  // 1. if installed, return
  if (install.installed) return; // 2. global registration for all components in components array
...
//# sourceMappingURL=Vue3Prism.umd.js.map